...
# Пример с выводом -> False

line = "Трам-пара-папам-парам-па-пам-пам-па Пум-пурум-пу-пурум-трам-пам-па"
lines = line.split()
...
# Пример с выводом -> True

line = "Пам-парам-пурум Пум-пурум-карам"
lines = line.split()
lst = [sum(x in 'уеыаоэяию' for x in lin)
   for lin in lines]
if len(set(lst)) == 1:
